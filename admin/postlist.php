...
<div class="grid_10">
 ...
 <?php 
	...
	|| <a href="editpost.php?editpostid=<?php echo $result['id'];?>">Edit</a> || <a onclick="return confirm('Are you sure want to delete now !!!');" href="deletepost.php?deletepostid=<?php echo $result['id'];?>">Delete</a>
<?php } ?>
	</td>
		</tr>
	<?php } } ?>
